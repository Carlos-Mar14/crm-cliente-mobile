...
import { Button, DataTable, IconButton, Modal, TextInput, Text } from 'react-native-paper'
...
export default function ComponentDocuments({ customerId }: { customerId: number }) {
  ...
  async function getCustomerCardDocuments() {
    try {
      ...
      <DataTable>
        ...
        {documents.map((document) => (
          <DataTable.Row key={document.id}>
            ...
            <DataTable.Cell>{document.file}</DataTable.Cell>
